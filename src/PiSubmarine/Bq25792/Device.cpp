...
namespace PiSubmarine::Bq25792
{
	...
	Result<MilliVolts> Device::GetMinimalSystemVoltage() const
	{
	...
	Result<void> Device::SetMinimalSystemVoltage(MilliVolts valueMv) const
	{
		uint8_t value = (valueMv.Value - 2500) / 250;
		return WriteField<RegOffset::MinimalSystemVoltage>(value, 0, 6);
	}

	Result<MilliVolts> Device::GetChargeVoltageLimit() const
	{
	...
	Result<void> Device::SetChargeVoltageLimit(MilliVolts valueMv) const
	{
		uint16_t value = valueMv.Value / 10;
		return WriteField<RegOffset::ChargeVoltageLimit>(value, 0, 11);
	}

	Result<MilliAmperes> Device::GetChargeCurrentLimit() const
	{
	...
	Result<void> Device::SetChargeCurrentLimit(MilliAmperes valueMa) const
	{
		uint16_t value = valueMa.Value / 10;
		return WriteField<RegOffset::ChargeCurrentLimit>(value, 0, 9);
	}

	Result<MilliVolts> Device::GetDynamicPowerManagementInputVoltageLimit() const
	{
	...
	Result<void> Device::SetDynamicPowerManagementInputVoltageLimit(MilliVolts valueMv) const
	{
		uint16_t value = valueMv.Value / 100;
		return WriteField<RegOffset::InputVoltageLimit>(value, 0, 8);
	}

	Result<MilliAmperes> Device::GetDynamicPowerManagementInputCurrentLimit() const
	{
	...
	Result<void> Device::SetDynamicPowerManagementInputCurrentLimit(MilliAmperes valueMa) const
	{
		uint16_t value = valueMa.Value / 10;
		return WriteField<RegOffset::InputCurrentLimit>(value, 0, 9);
	}

	Result<PrechargeControl> Device::GetPrechargeControl() const
	{
		uint8_t regValue;
	...
	Result<void> Device::SetPrechargeControl(const PrechargeControl& value) const
	{
		uint8_t regValue = 0;
	...
	Result<void> Device::Reset() const
	{
		return WriteField<RegOffset::TerminationControl>(1, 6, 1);
	}

	Result<MilliAmperes> Device::GetTerminationCurrent() const
	{
	...
	Result<void> Device::SetTerminationCurrent(MilliAmperes valueMa) const
	{
		uint8_t value = valueMa.Value / 40;
		return WriteField<RegOffset::TerminationControl>(value, 0, 5);
	}

	Result<Cells> Device::GetCells() const
	{
	...
	Result<void> Device::SetCells(const Cells& value) const
	{
		return WriteField<RegOffset::RechargeControl>(value, 6, 2);
	}

	Result<RechargeDeglichTime> Device::GetRechargeDeglichTime() const
	{
		return ReadFieldEnum<RegOffset::RechargeControl, RechargeDeglichTime>(4, 2);
	}

	Result<void> Device::SetCells(const RechargeDeglichTime& value) const
	{
		return WriteFieldEnum<RegOffset::RechargeControl>(value, 4, 2);
	}

	Result<MilliVolts> Device::GetRechargeThresholdOffset() const
	{
		return ReadFieldUnit<RegOffset::RechargeControl>(0, 4, 50_mV, 50_mV);
	}

	Result<void> Device::SetRechargeThresholdOffset(MilliVolts valueMv) const
	{
		return WriteFieldUnit<RegOffset::RechargeControl>(0, 4, valueMv, 50_mV, 50_mV);
	}

	Result<MilliVolts> Device::GetOtgRegulationVoltage() const
	{
		return ReadFieldUnit<RegOffset::VotgRegulation>(0, 11, 2800_mV, 10_mV);
	}

	Result<void> Device::SetOtgRegulationVoltage(MilliVolts valueMv) const
	{
		return WriteFieldUnit<RegOffset::VotgRegulation>(0, 11, valueMv, 2800_mV, 10_mV);
	}

	Result<PrechargeSafetyTimer> Device::GetPrechargeSafetyTimer() const
	{
		return ReadFieldEnum<RegOffset::IotgRegulation, PrechargeSafetyTimer>(7, 1);
	}

	Result<void> Device::SetPrechargeSafetyTimer(PrechargeSafetyTimer value) const
	{
		return WriteFieldEnum<RegOffset::RechargeControl>(value, 7, 1);
	}

	Result<MilliAmperes> Device::GetOtgCurrentLimit() const
	{
		return ReadFieldUnit<RegOffset::IotgRegulation>(0, 7, 0_mA, 40_mA);
	}

	Result<void> Device::SetOtgCurrentLimit(MilliAmperes valueMa) const
	{
		return WriteFieldUnit<RegOffset::IotgRegulation>(0, 7, valueMa, 0_mA, 40_mA);
	}

	Result<ThermalRegulation> Device::GetThermalRegulationThreshold() const
	{
		return ReadFieldEnum<RegOffset::TemperatureControl, ThermalRegulation>(6, 2);
	}

	Result<void> Device::SetThermalRegulationThreshold(const ThermalRegulation& value) const
	{
		return WriteFieldEnum<RegOffset::TemperatureControl>(value, 6, 2);
	}

	Result<ThermalShutdown> Device::GetThermalShutdownThreshold() const
	{
		return ReadFieldEnum<RegOffset::TemperatureControl, ThermalShutdown>(4, 2);
	}

	Result<void> Device::SetThermalShutdownThreshold(const ThermalShutdown& value) const
	{
		return WriteFieldEnum<RegOffset::TemperatureControl>(value, 4, 2);
	}

	Result<void> Device::SetTsIgnore(bool value) const
	{
		uint8_t value8 = value ? 1 : 0;
		return WriteField<RegOffset::NtcControl1>(value8, 0, 1);
	}

	Result<bool> Device::GetTsIgnore() const
	{
	...
	Result<IbatReg> Device::GetOtgMaxCurrent() const
	{
	...
	Result<void> Device::SetOtgMaxCurrent(IbatReg value) const
	{
		return WriteField<RegOffset::ChargerControl5>(static_cast<uint8_t>(value), 3, 2);
	}

	Result<bool> Device::IsSfetPresent() const
	{
	...
	Result<void> Device::SetSfetPresent(bool value) const
	{
		return WriteField<RegOffset::ChargerControl5>(value ? 1 : 0, 7, 1);
	}

	Result<bool> Device::IsDischargeCurrentSensingEnabled() const
	{
	...
	Result<void> Device::SetDischargeCurrentSensingEnabled(bool value) const
	{
		return WriteField<RegOffset::ChargerControl5>(value ? 1 : 0, 5, 1);
	}

	Result<bool> Device::IsIlimHizCurrentLimitEnabled() const
	{
	...
	Result<void> Device::SetIlimHizCurrentLimitEnabled(bool value) const
	{
		return WriteField<RegOffset::ChargerControl5>(value ? 1 : 0, 1, 1);
	}

	Result<bool> Device::IsDischargeOcpEnabled() const
	{
	...
	Result<void> Device::SetDischargeOcpEnabled(bool value) const
	{
		return WriteField<RegOffset::ChargerControl5>(value ? 1 : 0, 0, 1);
	}

	Result<bool> Device::GetWdRst() const
	{
	...
	Result<void> Device::SetWdRst(bool value) const
	{
		return WriteField<RegOffset::ChargerControl1>(value ? 1 : 0, 3, 1);
	}

	Result<Watchdog> Device::GetWatchdog() const
	{
	...
	Result<void> Device::SetWatchdog(Watchdog value) const
	{
		return WriteField<RegOffset::ChargerControl1>(static_cast<uint8_t>(value), 0, 3);
	}

	Result<VacOvp> Device::GetVacOvervoltageThreshold() const
	{
		return ReadFieldEnum<RegOffset::ChargerControl1, VacOvp>(4, 2);
	}

	Result<void> Device::SetVacOvervoltageThreshold(VacOvp value) const
	{
		return WriteFieldEnum<RegOffset::ChargerControl1, VacOvp>(value, 4, 2);
	}

	Result<AdcSpeed> Device::GetAdcSampleSpeed() const
	{
	...
	Result<void> Device::SetAdcSampleSpeed(AdcSpeed value) const
	{
		return WriteField<RegOffset::AdcControl>(static_cast<uint8_t>(value), 4, 2);
	}

	Result<bool> Device::IsAdcEnabled() const
	{
	...
	Result<void> Device::SetAdcEnabled(bool value) const
	{
		return WriteField<RegOffset::AdcControl>(value ? 1 : 0, 7, 1);
	}

	Result<ChargerStatus0Flags> Device::GetChargerStatus0() const
	{
	...
	Result<ChargeStatus> Device::GetChargeStatus() const
	{
	...
	Result<VbusStatus> Device::GetVbusStatus() const
	{
	...
	Result<bool> Device::IsBc12DetectionComplete() const
	{
	...
	Result<IcoStatus> Device::GetIcoStatus() const
	{
	...
	Result<bool> Device::IsInThermalRegulation() const
	{
	...
	Result<bool> Device::IsDpDmDetectionOngoing() const
	{
	...
	Result<bool> Device::IsBatteryPresent() const
	{
	...
	Result<Fault0> Device::GetFault0() const
	{
		return ReadFieldEnum<RegOffset::FaultStatus0, Fault0>(0, 8);
	}

	Result<Fault1> Device::GetFault1() const
	{
		return ReadFieldEnum<RegOffset::FaultStatus1, Fault1>(0, 8);
	}

	Result<MilliAmperes> Device::GetIbusCurrent() const
	{
	...
	Result<MilliAmperes> Device::GetIbatCurrent() const
	{
	...
	Result<MilliVolts> Device::GetVbusVoltage() const
	{
	...
	Result<MilliVolts> Device::GetVbatVoltage() const
	{
	...
	Result<MilliVolts> Device::GetVsysVoltage() const
	{
	...
	Result<NormalizedIntFraction<16>> Device::GetTsPercentage() const
	{
	...
	Result<Celcius> Device::GetDieTemperature() const
	{
	...
	Result<MilliVolts> Device::GetUsbDataPlusVoltage() const
	{
	...
	Result<MilliVolts> Device::GetUsbDataMinusVoltage() const
	{
	...
	Result<bool> Device::IsAutomaticDpDmDetectionEnabled() const
	{
	...
	Result<void> Device::SetAutomaticDpDmDetectionEnabled(bool value) const
	{
		return WriteField<RegOffset::ChargerControl2>(value ? 1 : 0, 6, 1);
	}

	Result<void> Device::ForceDpDmDetection() const
	{
		return WriteField<RegOffset::ChargerControl2>(1, 7, 1);
	}

	Result<DpDac> Device::GetDpDac() const
	{
		return ReadFieldEnum<RegOffset::DpDmDriver, DpDac>(5, 3);
	}

	Result<void> Device::SetDpDac(DpDac value) const
	{
		return WriteFieldEnum<RegOffset::DpDmDriver>(value, 5, 3);
	}

	Result<DmDac> Device::GetDmDac() const
	{
		return ReadFieldEnum<RegOffset::DpDmDriver, DmDac>(5, 3);
	}

	Result<void> Device::SetDmDac(DmDac value) const
	{
		return WriteFieldEnum<RegOffset::DpDmDriver>(value, 5, 3);
	}
